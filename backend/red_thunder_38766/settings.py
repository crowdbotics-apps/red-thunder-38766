"""
Django settings for red_thunder_38766 project.
...
ROOT_URLCONF = 'red_thunder_38766.urls'
...
WSGI_APPLICATION = 'red_thunder_38766.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_thunder_38766 API",
    "DESCRIPTION": "API documentation for red_thunder_38766 App",
    "VERSION": "v1",
}
